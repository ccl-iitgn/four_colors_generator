...
function App() {
  ...
  const [nGrids, setnGrids] = useState(50)
  ...
  useEffect(() => {
    ...
    console.log("No.of Grids", results.length)
    ...
    for (let result of results) {
      ...
      const assignColors = (structIndex) => {
        if (structIndex === structures.length) {
          return true; 
        }
        
        const structure = structures[structIndex];
      ...
      if (assignColors(0)) {
        coloredResults.push(structures);
      }
    }
      ...
      <div className="controls">
        ...
        <label>
          ...
          <input
            ...
            max="100"
            value={nGrids}
            onChange={(e) => setnGrids(parseInt(e.target.value))}
          />
        </label>
      </div>
